...
public class GuoneiFragment extends BaseFragment implements ItheMostShowView {
    ...
    protected void initView(View view) {
        mListView= (ListView) view.findViewById(R.id.lv_top_news);
        refreshLayout= (SwipeRefreshLayout) view.findViewById(R.id.refresh);

        new TheMostPresenter(GuoneiFragment.this,"guonei").fetch();
